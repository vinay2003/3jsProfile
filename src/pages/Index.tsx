...
import { ArrowRight, Code, Users, Globe, Star, Briefcase, Mail, ExternalLink } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <>
      ...
      <div ref={scrollRef} className={`min-h-screen bg-background text-foreground overflow-x-hidden ${isLoading ? 'hidden' : ''}`}>
        <AdvancedCursor />
        <Navbar />
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {['3D Web Development', 'Interactive Experiences', 'Creative Development', 'UI/UX Design', 'Performance Optimization'].map((item, index) => (
                    <li key={index}>
                      <motion.a 
                        href="#"
                        className="text-foreground/60 hover:text-primary transition-colors inline-block"
